...
impl CreateBinaryOperator2<String> for MetaAddRasterOperator {
...
impl AutoGenerateDynBinaryCombos for MetaAddRasterOperator {}
...
impl MetaRasterOperator for MetaAddRasterOperator {
    ...
    fn create_u8_raster_op(&self) -> Box<dyn RasterSource<RasterType = u8>> {
        self.auto_create_u8_raster_op::<MetaAddRasterOperator>()
    }
    fn create_u16_raster_op(&self) -> Box<dyn RasterSource<RasterType = u16>> {
        self.auto_create_u16_raster_op::<MetaAddRasterOperator>()
    }
